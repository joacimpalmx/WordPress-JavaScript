    ...
    echo '<p>No content found</p>';
        ...
        <div class="home-columns clearfix">
            ...
            <div class="one-half">
                ...
                $opinionPosts = new WP_Query('cat=4&posts_per_page=2'); //orderby=title, &order=ASC (ascending)
                ...
                <span class="horiz-center"><a href="<?php echo get_category_link(4); ?>" class="btn-a">View all Lean Posts</a></span>
            </div><!-- /one-half -->
